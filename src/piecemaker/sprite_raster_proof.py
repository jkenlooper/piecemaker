...
def generate_sprite_raster_proof_html(pieces_json_file, output_dir, scale):
    """Create a sprite proof showing how the image was cut. Should look like
    original."""

    # TODO: load the offsets from the sprite_without_padding_layout and add
    # background-position styles and such.
